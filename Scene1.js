...
create(){
	...
	this.aideDashText = this.add.text(100, 100, "Mince, vous êtes ralentis, appuyez sur A pour dash !", {'font': '14px', fill: '#fff'});
...
update() {
	...
	if(this.player.x > 10 && this.player.x < 150 && this.player.y <= 300){
	...
	if(this.player.x > 800 && this.player.x < 1000 && this.player.y <= 300 && this.score<40){
	...
	if(this.player.x > 800 && this.player.x < 1000 && this.player.y <= 300 && this.score>=40 && this.score<=90){
